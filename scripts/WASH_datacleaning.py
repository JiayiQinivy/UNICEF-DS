...
FILE          = os.path.join(os.path.dirname(SCRIPT_DIR), "data", "JMP-WASH-in-schools-2024-data-by-country.xlsx")
OUTPUT_FOLDER = os.path.join(os.path.dirname(SCRIPT_DIR), "outputs")
